...
Podemos atribuir essa popularidade ao principal objetivo do time React que é tonar a criação de UI's o mais simples possível para o desenvolvedor para que entreguemos uma melhor experiência para o usuário final.

Um dos fatores que simplifica a criação de UI's utilizando React é o fato de ele usar o paradigma de programação declarativa. Dessa forma precisamos nos preocupar mais com "O que" e menos com o "Como". Em outras palavras, precisamos simplesmente "falar" para o React: "Dado o estado X na minha aplicação, apresente a UI desta forma para o usuário". É o React então que se encarregará , de forma eficiente, do "Como" isto será feito. Além disso, a programação declarativa torna o código mais previsível e mais fácil de "debugar".
